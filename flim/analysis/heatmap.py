...
class HeatmapConfigDlg(BasicAnalysisConfigDlg):
    ...
    def __init__(self, parent, title, input={}, selectedgrouping=['None'], selectedfeatures='All', corr_type='pearson', numbers=False):
        self.corr_type = corr_type
        self.numbers = numbers
        BasicAnalysisConfigDlg.__init__(self, parent, title, input, enablegrouping=False, selectedgrouping=selectedgrouping, selectedfeatures=selectedfeatures)
