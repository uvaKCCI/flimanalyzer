...
class dataimporter():
    ...
    def get_reserved_categorycols(self, parser=None):
        if parser is None:
            parser = self.parser
        rcatnames = ['Cell line', 'Category', 'Cat', 'Cluster', 'FOV', 'Well', 'Cell', 'Treatment', 'Treatment 1', 'Treatment 2', 'Treatment 1 & 2', 'Time', 'Compartment', 'New Cat', 'Origin', 'AE Label', 'Source']    
